  ...
  return (
    ...
    <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
      ...
      <p className="text-base/loose text-center mb-10 opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
        Meri terhubung dengan saya.
      </p>
      <form
        action="https://formcarry.com/s/Ai4vQRCkKkI"
        method="POST"
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-violet-700 p-3 rounded-md w-full cursor-pointer border border-zinc-600 hover:bg-violet-600"
            >
              Kirim Pesan
            </button>
          </div>
